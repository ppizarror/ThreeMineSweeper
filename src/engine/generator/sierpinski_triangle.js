...
function SierpinskiTriangle() {
    ...
    this._generate = function (xi, yi, zi, xf, yf, zf) {
        ...
        // Calculate height
        let h = Math.sqrt(6) * a / 3;

        // Create vertices
        let v1 = new Vertex(xo - (r * Math.sin(60 * Math.PI / 180)),
            yo - (r * Math.cos(60 * Math.PI / 180)), zo - (h / 2));
        let v2 = new Vertex(xo + (r * Math.sin(60 * Math.PI / 180)),
            yo - (r * Math.cos(60 * Math.PI / 180)), zo - (h / 2));
        let v3 = new Vertex(xo, yo + r, zo - (h / 2));
        let v4 = new Vertex(xo, yo, zo + (h / 2));
     ...
     * @private
     */
    this._sierpinksi = function (v1, v2, v3, v4, step, cube) {
         ...
         */
        if (step === this._order) {
            let f1 = new Face([v1, v4, v2], cube + '+F1');
            let f2 = new Face([v2, v4, v3], cube + '+F2');
            let f3 = new Face([v3, v4, v1], cube + '+F3');
            let f4 = new Face([v1, v2, v3], cube + '+F4');
