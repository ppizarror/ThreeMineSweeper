...
lang_db.en = {
    ...
    "error_errordb_langinit_moreinfo": "Language entry of error <{0}> does not exist in langs",
    "error_errordb_langinit_msg": "Language entry of error <{0}> does not exist in lang definition",
    "error_message": "Error",
    ...
    "import_fatal_error_content": "The library {0} could not been imported from path {1}",
    ...
    "new_game_bad_volume": "The generated figure cannot be played, try again using another configuration",
    "new_game_function_bad": "The function {0} is invalid",
    "new_game_function_button": "Examples",
    "new_game_function_examples_title": "Function examples",
    "new_game_function_placeholder": "Write a function (x,y)",
    "new_game_function_select_drop": "Pick a function z=f(x,y)",
    "new_game_gen_item": "Item",
    "new_game_gen_select_item": "Select an item",
