THREE.OrbitControls = function (L, M) {
    ...
    function G() {
        return Math.pow(0.95, J.zoomSpeed)
    }
    ...
    function u(ad) {
        z.set(ad.clientX, ad.clientY)
    }

    function T(ad) {
        w.set(ad.clientX, ad.clientY)
    }

    function E(ad) {
        d.set(ad.clientX, ad.clientY)
    }
    ...
    function k(ad) {
        z.set(ad.touches[0].pageX, ad.touches[0].pageY)
    }
