...
function(c,b,a){is_null_undf(a)&&(a={});a=$.extend({backgroundDismiss:!1,closeIcon:!1,draggable:!1,escapeCancelKey:!1,size:this.options.size.SMALL},a);this._create_dialog(c,b,a)};this.form=function(c,b,a,g,e){is_null_undf(e)&&(e={});is_null_undf(g)&&(g=function(){});is_null_undf(a)&&(app_console.warn(lang.dialog_form_submit_null),a=function(){});e=$.extend({backgroundDismiss:!1,cancelButtonClass:this.options.buttons.DEFAULT,cancelText:lang.dialog_form_cancel,closeIcon:!1,closeAfterSubmit:!0,escapeCancelKey:!1,
submitButtonClass:this.options.buttons.BLUE,submitText:lang.dialog_form_send},e);if(e.closeAfterSubmit){var d=a;a=function(){d();this.close()}}e.confirm=a;e.cancel=g;e.confirmButtonClass=e.submitButtonClass;e.confirmText=e.submitText;delete e.submitButtonClass;delete e.submitText;var h=function(){};not_null_undf(e.onContentReady)&&e.onContentReady instanceof Function&&(h=e.onContentReady);e.onContentReady=function(){h();var k=null,l=this;not_null_undf(l)&&l.hasOwnProperty("$content")&&(k=l.$content);
is_null_undf(k)&&(k=$(".jconfirm-content"));if(!is_null_undf(k))k.find("form").on("submit",function(m){m.preventDefault();is_null_undf(l)||l.$$confirm.trigger("click")})};this._create_dialog(c,b,e)};this._create_dialog=function(c,b,a){f._close_last&&f.close_last();a=$.extend({animateFromElement:!1,animation:this.options.animation.ZOOM,animationBounce:1,animationSpeed:400,backgroundDismiss:"cancel",buttonMaxLength:30,cancel:null,cancelButtonClass:this.options.buttons.DEFAULT,cancelText:lang.answer_no,
...
a.confirm=null),g.confirm={action:a.confirm,btnClass:a.confirmButtonClass,keys:["y","enter"],text:a.confirmText});not_null_undf(a.cancelText)&&""!==a.cancelText&&(a.cancelText=a.cancelText.toString(),a.cancelText.length>a.buttonMaxLength&&(a.cancelText=a.cancelText.substring(0,a.buttonMaxLength-3)+"&hellip;"),!not_null_undf(a.cancel)||a.cancel instanceof Function||(app_console.warn(lang.dialog_error_button_function_null.format(a.cancelText.toUpperCase())),a.cancel=null),g.cancel={action:a.cancel,
btnClass:a.cancelButtonClass,keys:["n"],text:a.cancelText});a.buttons=g;not_null_undf(c)&&""!==c&&(a.title=c);not_null_undf(b)&&""!==b&&(a.content=b);!is_null_undf(a.onClose)&&a.onClose instanceof Function||(a.onClose=function(){});!is_null_undf(a.onContentReady)&&a.onContentReady instanceof Function||(a.onContentReady=function(){});!is_null_undf(a.onDestroy)&&a.onDestroy instanceof Function||(a.onDestroy=function(){});!is_null_undf(a.onOpen)&&a.onOpen instanceof Function||(a.onOpen=function(){});
!is_null_undf(a.onOpenBefore)&&a.onOpenBefore instanceof Function||(a.onOpenBefore=function(){});var e=a.onContentReady;a.onContentReady=function(){e();var h=$(".jconfirm-box");a.disableSelect&&h.addClass("noselect");a.forceCursorDefault&&h.addClass("jconfirm-default-cursor")};var d=a.onDestroy;a.onDestroy=function(){d()};f._dialog_size(a);c=$.extend({},a);delete c.boxWidth;delete c.size;c=md5(JSON.stringify(a));not_null_undf(this._last.object)&&this._last.md5===c&&!this._last.object.isClosed()&&
(app_console.info(lang.dialog_last_closed_equal_opened),f.close_last());b=$.confirm(a);app_console.info(lang.dialog_popup_created.format(c));this._last.md5=c;this._last.$options=a;this._last.object=b};this._dialog_size=function(c){var b=get_element_width(app_dom.window);switch(c.size){case this.options.size.SMALL:c.boxWidth=350>=b?"95%":400>=b?"57%":500>=b?"53%":600>=b?"48%":700>=b?"43%":800>=b?"38%":900>=b?"35%":1E3>=b?"31%":"30%";break;case this.options.size.NORMAL:c.boxWidth=350>=b?"95%":400>=
b?"67%":500>=b?"60%":600>=b?"58%":700>=b?"54%":800>=b?"50%":900>=b?"46%":1E3>=b?"44%":"37%";break;case this.options.size.LARGE:c.boxWidth=350>=b?"95%":400>=b?"85%":500>=b?"78%":600>=b?"74%":700>=b?"71%":800>=b?"67%":900>=b?"63%":1E3>=b?"60%":"55%";break;case this.options.size.FULL:c.boxWidth="95%";break;default:app_console.warn(lang.app_dialog_unknown_size.format(c.size)),c.useBootstrap=!0,delete c.size}};this.close_last=function(){not_null_undf(f._last.object)&&f._last.object.close()};this.open_last=
function(){not_null_undf(f._last.object)&&f._last.object.open()};this.enable_close_last=function(){f._close_last=!0}}var app_dialog=new AppDialog;app_dialog.enable_close_last();
