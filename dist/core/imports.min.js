...
"lib/mmenu/jquery.mmenu.all.js",function(b){a.add_lib_to_queue(a.lib.HAMMER);a._getScript_async_callback(a.lib.HAMMER,"lib/hammer/hammer.min.js",b.c,b.p)},{c:c,p:d});break;case a.lib.RIPPLER:a.load_css_lib(b,"lib/rippler/rippler.min.css");this._getScript_async_callback(b,"lib/rippler/rippler.min.js",c,d);break;case a.lib.SPIN:a.load_css_lib(b,"lib/spin/spin.css");this._getScript_async_callback(b,"lib/spin/spin.min.js",c,d);break;case a.lib.BOWSER:this._getScript_async_callback(b,"lib/bowser/bowser.min.js",
...
"lib/underscore/underscore-min.js",function(c){a.add_lib_to_queue("jquery.events.input");a.add_lib_to_queue("jquery.elastic");a._getScript_async("jquery.events.input","lib/jquery-mentions-input/jquery.events.input.min.js");a._getScript_async("jquery.elastic","lib/jquery-mentions-input/jquery.elastic.min.js");a._getScript_async_callback(b,"lib/jquery-mentions-input/jquery.mentionsInput.min.js",c.c,c.p)},{c:c,p:d});break;case a.lib.UNDERSCORE:this._getScript_async_callback(b,"lib/underscore/underscore-min.js",
...
app_library_manager.import_async_library(app_library_manager.lib.JQUERYNICESELECT);app_library_manager.import_async_library(app_library_manager.lib.MATHPARSER)}jQuery.fn.tooltipster=function(){};jQuery.fn.alert=function(){};jQuery.fn.confirm=function(){};var bowser,Spinner,Parser;
