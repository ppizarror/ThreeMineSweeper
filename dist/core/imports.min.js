...
!0;$.getScript(c,f).fail(function(){a._throw_fatal_error(b,c)})}catch(g){}finally{}return!1};this.import_async_library=function(b,c,d,e){if(!a._initapp)throw"LibraryManager::import_async_library Application is not initialized yet, the library has not been downloaded "+b;is_null_undf(c)&&(c=function(){});if(b instanceof Array)if(1===b.length)b=b[0];else{var f=b.splice(0,1),g=b;b=f[0];c=function(b,c,f){return function(){1===g.length&&(g=g[0]);a.import_async_library(g,c,d,f)}}(g,c,e)}if(this.is_loaded_library(b)||
d)a._loadLibrary(b,c,e);else{if(-1===Object.keys(a._importLibQueue).indexOf(b)){a.add_lib_to_queue(b);a._importTime[b]=new Date;try{return a._loadLibrary(b,c,e),!0}catch(h){NotificationJS.error(h.message)}finally{}return!1}a._create_waiting_thread(b,c,e)}return!0};this._create_waiting_thread=function(b,c,d){if(void 0!==c){var e=generateID();a._waitingThreadData[e]={callback:c,id:e,params:d,threadid:0};a._waitingThreadData[e].threadid=setInterval(function(){if(a.is_loaded_library(b)){var c=a._waitingThreadData[e];
clearInterval(c.threadid);void 0!==c.params?c.callback(c.params):c.callback();delete a._waitingThreadData[e]}},cfg_module_async_wait)}};this._getScript_async=function(a,c){return this._getScript_async_callback(a,c,function(){})};this.load_css_lib=function(b,c){a._importedLibraries[b+".css"]||(a._importedLibraries[b+".css"]=!0,$("head").append('<link rel="stylesheet" type="text/css" href="'+c+'" media="screen">'))};this.import_all_libraries=function(){if(a._initapp)throw"LibraryManager::import_all_libraries The application has been initizlied, the libraries could not been downloaded";
