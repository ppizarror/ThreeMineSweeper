...
MIN_TOL};this.close_to=function(a){return this.dist(a)<MIN_TOL};this.ccw=function(a,b){if(this.equals(a)||this.equals(b))return!1;var c=a.get_x()-this.get_x(),d=a.get_y()-this.get_y();a=a.get_z()-this.get_z();var e=b.get_x()-this.get_x(),f=b.get_y()-this.get_y();b=b.get_z()-this.get_z();return!(0<d*b-f*a||0<c*b-e*a||0<c*f-e*d)};this.collinear=function(a,b){return this.equals(a)||this.equals(b)?!1:0===this.area2(a,b)};this.area2=function(a,b){if(this.equals(a)||this.equals(b))return 0;var c=a.get_x()-
this.get_x(),d=a.get_y()-this.get_y();a=a.get_z()-this.get_z();var e=b.get_x()-this.get_x(),f=b.get_y()-this.get_y();b=b.get_z()-this.get_z();return.5*Math.sqrt(Math.pow(d*b-f*a,2)+Math.pow(c*b-e*a,2)+Math.pow(c*f-e*d,2))};this.scale=function(a,b,c,d){is_null_undf(b)&&(b=1);is_null_undf(c)&&(c=1);is_null_undf(d)&&(d=1);this.set_x(this.get_x()*a*b);this.set_y(this.get_y()*a*c);this.set_z(this.get_z()*a*d)};this.translate=function(a,b,c){is_null_undf(a)&&(a=0);is_null_undf(b)&&(b=0);is_null_undf(c)&&
...
function(a,b){return Math.abs(a-b)<MIN_TOL};this.join_replace=function(a){if(!this.equal_position(a))return!1;this.set_name(a.get_name());for(var b=a.get_faces(!0),c=0;c<b.length;c+=1)this.add_face(b[c]),a.remove_face(b[c]),b[c].replace_vertex(a,this);return!0};this.set_name(l)};
