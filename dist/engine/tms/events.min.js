...
this._canvas_parent=this._three_camera=this._volume=this._last_hover_face=null;this._altevents=!1;const a=this;this.set_viewer=function(b){a._viewer=b;a._three_camera=b.get_camera();a._canvas_parent=b.get_canvas_parent();a._scene=b.get_scene();a._raycaster=b.get_raycaster()};this.set_minesweeper=function(b){a._minesweeper=b};this.set_volume=function(b){this._volume=b};this.initEvents=function(){is_null_undf(this._canvas_parent)||(this._canvas_parent.on(a._eventID.mousewheel,function(b){stop_wheel_event(b);
...
c=a._canvas_parent.innerWidth(),k=b.clientX-d.left+app_dom.window.scrollLeft(),f=b.clientY-d.top+app_dom.window.scrollTop(),g=0,h=0,l=k>=0&&k<=c&&f>=0&&f<=e;a._mouse.inside=l;a._mouse.x=k/c*2-1;a._mouse.y=-(f/e)*2+1;a._raycaster.setFromCamera(a._mouse,a._three_camera);c=a._raycaster.intersectObjects(a._scene.children,!1);if(is_null_undf(c)||c.length===0)l=!1,a._faceHover(null);else{e=f="";for(let m=0;m<a._viewer.objects_props.tooltip.modes.length;m+=1)f+=a._viewer.objects_props.tooltip.modes[m](c);
c=parseInt(f,10);isNaN(c)?this._faceHover(null):(f=this._volume.get_faces(),c>=0&&c<f.length&&(e=this._faceMouseHandler(f[c])));a._viewer.objects_props.tooltip.obj.html(e);e===""&&a._viewer.objects_props.tooltip.ignoreEmpty?l=!1:(g=a._viewer.objects_props.tooltip.obj.outerWidth(),g!==0&&g+b.clientX+a._viewer.objects_props.tooltip.left+app_dom.window.scrollLeft()>app_dom.window.width()?(a._viewer.objects_props.tooltip.obj.addClass("tooltip-left"),a._viewer.objects_props.tooltip.obj.removeClass("tooltip-right"),
