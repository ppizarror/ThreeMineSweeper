/*
 MIT
*/
function ThreeMineSweeper(){this._menu=this._mines=this._viewer=this._events=null;this._generator={facetarget:null,fun:"",item:"",latitude:null,longitude:null,mines:0,order:null,type:0};const b=this;this.init=function(a){b._viewer=new TMSViewer;b._events=new TMSEvents;b._mines=new Minesweeper;b._menu=new TMSMenu;b._viewer.init(a);b._events.set_viewer(b._viewer);b._events.set_minesweeper(b._mines);b._events.initEvents();!cfg_verbose&&cfg_reload_alert_onclose&&setTimeout(function(){window.onbeforeunload=
function(){return lang.reload_alert}},500);b._menu.init_menu()};this.set_generator=function(a,c,d,e,f,g,h){this._generator.type=a;this._generator.facetarget=d;this._generator.fun=g;this._generator.item=h;this._generator.latitude=e;this._generator.longitude=f;this._generator.order=c};this.set_mines=function(a){this._generator.mines=a};this._generate=function(){let a;switch(this._generator.type){case 0:a=new GenBasicCube;break;case 1:a=new GenBasicPyramid;break;case 2:a=new GenCrossFractal;break;case 3:a=
...
this.load_menu=function(){b.abort();b._menu.main_menu()};this.new=function(){b.abort();loadingHandler(!0);setTimeout(function(){let a=b._generate(),c=a.get_volume(),d=a.get_camera();b._mines.new(c,b._generator.mines,a.get_genid(),a.get_name(),a.get_type_id())?(b._events.set_volume(c),b._viewer.set_camera_pos(d.x,d.y,d.z),b._viewer.new(c),b._mines.new_game_ui(!0),b._viewer.focus(),loadingHandler(!1)):(loadingHandler(!1),app_dialog.confirm(lang.error_message,lang.new_game_bad_volume,{cancelText:null,
