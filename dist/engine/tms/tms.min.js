...
function(){return lang.reload_alert}},500);b._menu.init_menu()};this.set_generator=function(a,c,d,e,f,g,h){this._generator.type=a;this._generator.facetarget=d;this._generator.fun=g;this._generator.item=h;this._generator.latitude=e;this._generator.longitude=f;this._generator.order=c};this.set_mines=function(a){this._generator.mines=a};this._generate=function(){switch(this._generator.type){case 0:var a=new GenBasicCube;break;case 1:a=new GenBasicPyramid;break;case 2:a=new GenCrossFractal;break;case 3:a=
