...
a.objects_props.camera.maxvelocity.z*k);null!==a._helper_instances.fpsmeter&&console.log(a._helper_instances.fpsmeter.stats.getFPS())}};this._camera_inside=function(){return Math.abs(this._controls.target.x)<this.worldsize.x&&Math.abs(this._controls.target.y)<this.worldsize.y&&Math.abs(this._controls.target.z)<this.worldsize.z};this.stop_camera=function(){for(var b=Object.keys(a.objects_props.camera.movements),c=0;c<b.length;c+=1)a.objects_props.camera.movements[b[c]]=!1;b=Object.keys(a.objects_props.camera.targetspeed);
for(c=0;c<b.length;c+=1)a.objects_props.camera.targetspeed[b[c]]=0;return!1};this.camera_is_moving=function(){return 0!==a.objects_props.camera.targetspeed.x||0!==a.objects_props.camera.targetspeed.y||0!==a.objects_props.camera.targetspeed.z||0!==a.objects_props.camera.targetspeed.f||0!==a.objects_props.camera.targetspeed.p};this.camera_is_rotating=function(){return 0!==a.objects_props.camera.targetspeed.aup||0!==a.objects_props.camera.targetspeed.alf};this._different_sign=function(a,c){return 0<
...
a._update_camera_target("x",f*Math.cos(c)*Math.sin(d),!1);a._update_camera_target("y",b,!1);a._update_camera_target("z",e,!0)};this._move_ortho=function(b,c){var d=a._controls.getAzimuthalAngle();if(not_null_undf(b)&&not_null_undf(c))if(a.objects_props.camera.facerotate&&a.objects_props.camera.movements.facerotate)a._move_face_rotate(.001*b,.001*c);else{if(a.objects_props.camera.movements.pan){b*=-a.objects_props.camera.panfactor;c*=-a.objects_props.camera.panfactor;var f=b*Math.cos(d+Math.PI/2);
b*=Math.sin(d+Math.PI/2);a.objects_props.camera.panaddtospeed&&(a.objects_props.camera.targetspeed.x+=f*a.objects_props.camera.dampingfactor*a.objects_props.camera.panaddfactor,a.objects_props.camera.targetspeed.y+=b*a.objects_props.camera.dampingfactor*a.objects_props.camera.panaddfactor,a.objects_props.camera.targetspeed.p+=c*a.objects_props.camera.dampingfactor*a.objects_props.camera.panaddfactor);a._update_camera_target("x",f,!1);a._update_camera_target("y",b,!1);a._update_camera_target("x",c*
Math.cos(d),!1);a._update_camera_target("y",c*Math.sin(d),!0)}}else b=a.objects_props.camera.targetspeed.x*Math.cos(d+Math.PI/2),c=a.objects_props.camera.targetspeed.y*Math.sin(d+Math.PI/2),a._update_camera_target("x",b,!1),a._update_camera_target("y",c,!1),b=a.objects_props.camera.targetspeed.p*Math.cos(d),c=a.objects_props.camera.targetspeed.p*Math.sin(d),a._update_camera_target("x",b,!1),a._update_camera_target("y",c,!0)};this._move_face_rotate=function(b,c){if(is_null_undf(a.objects_props.camera.facetarget.x)||
...
function(){not_null_undf(a._gui)&&(a._gui.destroy(),a._gui=null,$("#"+a._guiID).empty())};this.toggle_fps_meter=function(){is_null_undf(a._helper_instances.fpsmeter)?app_library_manager.import_async_library(app_library_manager.lib.STATS,function(){var b=new Stats;b.display=a._threejs_helpers.displayfps;b.initialize();a._fps_parent.append(b.domElement);requestAnimationFrame(function d(){b.update();requestAnimationFrame(d)});a._helper_instances.fpsmeter={stats:b}}):(a._helper_instances.fpsmeter.stats.dom.remove(),
a._helper_instances.fpsmeter=null)};this._draw_helpers=function(){if(this._threejs_helpers.axis){if(is_null_undf(this._helper_instances.axis)){var b=new THREE.AxesHelper(Math.min(a.worldsize.x,a.worldsize.y,a.worldsize.z)*a._threejs_helpers.axissize);a._add_mesh_to_scene(b,this._globals.helper,!1);this._helper_instances.axis=b}}else not_null_undf(this._helper_instances.axis)&&a._scene.remove(this._helper_instances.axis),this._helper_instances.axis=null;if(this._threejs_helpers.planes){if(is_null_undf(this._helper_instances.planes)){b=
[];var c=new THREE.MeshBasicMaterial({color:a._threejs_helpers.planecolorx,opacity:a._threejs_helpers.planeopacity}),d=new THREE.MeshBasicMaterial({color:a._threejs_helpers.planecolory,opacity:a._threejs_helpers.planeopacity}),f=new THREE.MeshBasicMaterial({color:a._threejs_helpers.planecolorz,opacity:a._threejs_helpers.planeopacity});c.wireframe=!0;c.aoMapIntensity=a._threejs_helpers.planeopacity;d.wireframe=!0;d.aoMapIntensity=a._threejs_helpers.planeopacity;f.wireframe=!0;f.aoMapIntensity=a._threejs_helpers.planeopacity;
var e=new THREE.Geometry;e.vertices.push(this._new_three_point(this.worldsize.x,0,-this.worldsize.z),this._new_three_point(-this.worldsize.x,0,-this.worldsize.z),this._new_three_point(-this.worldsize.x,0,this.worldsize.z),this._new_three_point(this.worldsize.x,0,this.worldsize.z));e.faces.push(new THREE.Face3(0,1,2));e.faces.push(new THREE.Face3(0,2,3));c=new THREE.Mesh(e,c);c.position.y=0;a._add_mesh_to_scene(c,this._globals.helper,!1);b.push(c);e=new THREE.Geometry;e.vertices.push(this._new_three_point(0,
-this.worldsize.y,-this.worldsize.z),this._new_three_point(0,this.worldsize.y,-this.worldsize.z),this._new_three_point(0,this.worldsize.y,this.worldsize.z),this._new_three_point(0,-this.worldsize.y,this.worldsize.z));e.faces.push(new THREE.Face3(0,1,2));e.faces.push(new THREE.Face3(0,2,3));c=new THREE.Mesh(e,d);c.position.y=0;a._add_mesh_to_scene(c,this._globals.helper,!1);b.push(c);e=new THREE.Geometry;e.vertices.push(this._new_three_point(this.worldsize.x,this.worldsize.y,0),this._new_three_point(-this.worldsize.x,
this.worldsize.y,0),this._new_three_point(-this.worldsize.x,-this.worldsize.y,0),this._new_three_point(this.worldsize.x,-this.worldsize.y,0));e.faces.push(new THREE.Face3(0,1,2));e.faces.push(new THREE.Face3(0,2,3));c=new THREE.Mesh(e,f);c.position.y=0;a._add_mesh_to_scene(c,this._globals.helper,!1);b.push(c);this._helper_instances.planes=b}}else{if(not_null_undf(this._helper_instances.planes))for(b=this._helper_instances.planes,d=0;d<b.length;d+=1)this._scene.remove(b[d]);this._helper_instances.planes=
null}this._threejs_helpers.grid?is_null_undf(this._helper_instances.grid)&&(b=new THREE.GridHelper(2*Math.max(this.worldsize.x,this.worldsize.y),Math.floor(2/this._threejs_helpers.griddist)),b.position.y=0,b.material.opacity=.5,b.material.transparent=!0,a._add_mesh_to_scene(b,this._globals.helper,!1),this._helper_instances.grid=b):(not_null_undf(this._helper_instances.grid)&&this._scene.remove(this._helper_instances.grid),this._helper_instances.grid=null);if(this._threejs_helpers.worldlimits){if(is_null_undf(this._helper_instances.worldlimits)){b=
new THREE.MeshBasicMaterial({color:a._threejs_helpers.worldlimitscolor,opacity:a._threejs_helpers.planeopacity});b.wireframe=!0;b.aoMapIntensity=.5;d=new THREE.Geometry;d.vertices.push(this._new_three_point(this.worldsize.x,-this.worldsize.y,-this.worldsize.z),this._new_three_point(this.worldsize.x,this.worldsize.y,-this.worldsize.z),this._new_three_point(this.worldsize.x,this.worldsize.y,this.worldsize.z),this._new_three_point(this.worldsize.x,-this.worldsize.y,this.worldsize.z),this._new_three_point(this.worldsize.x,
...
this._globals.contour,!1),a._volume_meshes.contourminor.push(b))};this.init=function(b){a.id=b;a._canvas_parent=$(b);a._init_three();a._init_world_objects();a._init_tooltip();a.focus()};this.new=function(b){this.delete_last_volume();is_null_undf(b)||(this._load_textures(),this._draw_volume(b),a.init_animate())}};
