...
this._dom.menubutton.html('<i class="fas fa-home"></i> '+lang.game_back_to_menu);this._dom.resetbutton.html('<i class="fas fa-redo-alt"></i> '+lang.game_reset);this._dom.menubutton.on("click",function(){var b=function(){a._is_playing=!1;app_tms.load_menu()};app_sound.play(app_sound.sound.BUTTON);0===a._game_status.played||a._gameover?b():app_dialog.confirm(lang.leave_game_title,lang.leave_game_confirm,{cancel:function(){},confirm:b,confirmButtonClass:app_dialog.options.buttons.BLUE,icon:"fas fa-home",
size:app_dialog.options.size.SMALL})});this._dom.resetbutton.on("click",function(){var b=function(){a._reset=!0;app_tms.new()};app_sound.play(app_sound.sound.BUTTON);0===a._game_status.played||a._gameover?b():app_dialog.confirm(lang.reset_game_title,lang.reset_game_confirm,{cancel:function(){},confirm:b,confirmButtonClass:app_dialog.options.buttons.DANGER,icon:"fas fa-exclamation-triangle",size:app_dialog.options.size.SMALL})});a._update_counters();b&&a._load_score(!0);a._check_size.opened=!1;a._check_size.enabled&&
(app_dom.window.on("resize.checksize",a._check_window_size),a._check_window_size());this._dom.viewer.show();a._scoreboard_setup();a._reset=!1};this._check_window_size=function(){var b=app_dom.window.outerWidth(),c=app_dom.window.outerHeight();b>=a._check_size.width&&c>=a._check_size.height?(a._check_size.opened&&app_dialog.close_last(),a._check_size.opened=!1):a._check_size.opened||(a._check_size.opened=!0,app_dialog.confirm(lang.check_window_size_title,lang.check_window_size_info.format(round_number(b),
round_number(c),round_number(a._check_size.width),round_number(a._check_size.height)),{cancelText:null,confirm:function(){a._check_window_size()},confirmButtonClass:app_dialog.options.buttons.DANGER,confirmText:lang.answer_ok,icon:"fas fa-desktop",size:app_dialog.options.size.NORMAL}))};this._load_score=function(b){b&&a._scoreboard_setup();setTimeout(function(){a._get_score()},1E3)};this._update_counters=function(){var b=round_number(100*a._game_status.played/a._game_status.total,1);isNaN(b)&&(b=
0);a._dom.facecount.html("{0}/{1} ({2}%)".format(a._game_status.played,a._game_status.total,b));a._dom.flagcount.html(a._game_status.flags);a._dom.minecount.html(a._game_status.mines);a._dom.questioncount.html(a._game_status.questions)};this._request_username=function(){if(a._is_playing){var b=generateID(),c=sessionCookie.username;is_null_undf(c)&&(c="");app_dialog.form(lang.game_won_title,'{2}.<br><br><form action="" class="formName"><div class="form-group"><label for="{0}">{1}:</label><input type="text" class="form-control" id="{0}" minlength="4" maxlength="20" value="{4}" required aria-required="true" placeholder="{5}" aria-placeholder="{5}" {3}></div></form>'.format(b,
...
lang.start_new_game,{cancel:function(){},confirm:function(){a._reset=!0;app_tms.new()},backgroundDismiss:"cancel",confirmButtonClass:app_dialog.options.buttons.SUCCESS,escapeCancelKey:!0,icon:"fas fa-trophy",size:app_dialog.options.size.SMALL})},1E3)};this._new_game_after_lose=function(){a._is_playing&&setTimeout(function(){app_dialog.confirm(lang.game_over,lang.start_new_game,{cancel:function(){},confirm:function(){a._reset=!0;app_tms.new()},backgroundDismiss:"cancel",confirmButtonClass:app_dialog.options.buttons.DANGER,
escapeCancelKey:!0,icon:"fas fa-bomb",size:app_dialog.options.size.SMALL})},1E3)};this._get_score=function(){var b=$.ajax({crossOrigin:cfg_ajax_cors,data:"m=get&id={0}&g={1}".format(a._generator.id,a._generator.type_id),timeout:cfg_href_ajax_timeout,type:"get",url:cfg_href_score});b.done(function(b){try{var c=JSON.parse(b);if(-1===Object.keys(c).indexOf("error")){a._write_scores(c);return}}catch(f){app_console.exception(f)}finally{}NotificationJS.error(lang.score_error_get);app_console.error(b);a._write_scores(null)});
