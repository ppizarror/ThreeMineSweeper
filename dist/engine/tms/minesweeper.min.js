...
lang.start_new_game,{cancel:function(){},confirm:function(){a._reset=!0;app_tms.new()},backgroundDismiss:"cancel",confirmButtonClass:app_dialog.options.buttons.SUCCESS,escapeCancelKey:!0,icon:"fas fa-trophy",size:app_dialog.options.size.SMALL})},100)};this._new_game_after_lose=function(){a._is_playing&&setTimeout(function(){app_dialog.confirm(lang.game_over,lang.start_new_game,{cancel:function(){},confirm:function(){a._reset=!0;app_tms.new()},backgroundDismiss:"cancel",confirmButtonClass:app_dialog.options.buttons.DANGER,
escapeCancelKey:!0,icon:"fas fa-bomb",size:app_dialog.options.size.SMALL})},100)};this._get_score=function(){var b=$.ajax({crossOrigin:cfg_ajax_cors,data:"m=get&id={0}&g={1}".format(a._generator.id,a._generator.type_id),timeout:cfg_href_ajax_timeout,type:"get",url:cfg_href_score});b.done(function(b){try{var c=JSON.parse(b);if(-1===Object.keys(c).indexOf("error")){a._write_scores(c);return}}catch(f){app_console.exception(f)}finally{}NotificationJS.error(lang.score_error_get);app_console.error(b);a._write_scores(null)});
