...
b);r=Math.min(1,r/Math.abs(b-m));m=(b+m)/2-g;g=[];for(b=0;b<l;b+=1)for(c=0;c<e;c+=1)d=h+p*b,a=k+q*c,f=(n(d,a)-m)*r,g.push(new Vertex(d,a,f,"Vs"+(b*l+c).toString()));d=[];b=1;for(f=0;f<l-1;f+=1)for(c=0;c<e-1;c+=1)a=new Face([g[e*f+c],g[e*f+c+1],g[e*(f+1)+c+1],g[e*(f+1)+c]],"Fs"+b.toString()),a.enable_uv_flip(),a.set_uv_rotation(-90),a.set_bomb_behaviour(a.behaviour.AROUND),a.disable_contour(),d.push(a),b+=1;this._volume.add_face(d);g=[];for(b=0;b<l;b+=1)for(c=0;c<e;c+=1)d=h+p*b,a=k+q*c,f=(n(d,a)-m)*
r-.0005,g.push(new Vertex(d,a,f,"Vi"+(b*l+c).toString()));d=[];b=1;for(h=0;h<l-1;h+=1)for(k=0;k<e-1;k+=1)a=new Face([g[e*h+k],g[e*h+k+1],g[e*(h+1)+k+1],g[e*(h+1)+k]],"Fi"+b.toString()),a.disable_face(),a.reverse_vertices(),a.disable_contour(),d.push(a),b+=1;this._volume.add_face(d);this._volume.disable_contour()}};
