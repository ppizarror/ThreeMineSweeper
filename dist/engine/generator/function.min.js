...
c,f=(n(d,a)-m)*r-5E-4,g.push(new Vertex(d,a,f,"Vi"+(b*l+c).toString()));d=[];b=1;for(h=0;h<l-1;h+=1)for(k=0;k<e-1;k+=1)a=new Face([g[e*h+k],g[e*h+k+1],g[e*(h+1)+k+1],g[e*(h+1)+k]],"Fi"+b.toString()),a.disable_face(),a.reverse_vertices(),a.disable_contour(),d.push(a),b+=1;this._volume.add_face(d);this._volume.disable_contour()}}};
